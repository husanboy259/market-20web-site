...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 49.99,
    image: "https://images.unsplash.com/photo-1627123756386-30a5d925b585?w=400&h=400&fit=crop",
    rating: 4.3,
    reviews: 89,
    category: "Accessories",
  },
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground">Explore our complete collection of quality items</p>
        </div>
            ...
            <div className="bg-white rounded-lg border border-border p-6 sticky top-24">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {["Electronics", "Fashion", "Accessories", "Photography"].map((cat) => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["5", "4 & above", "3 & above", "2 & above"].map((rating) => (
